...
import { TOKEN, TOKEN_LIST } from '@/config'
...
export default function TokenItem(props: any) {
  ...
  return (
    <div className={`flex w-full gap-3 items-center p-1 rounded hover:cursor-pointer ${setCoin && "hover:bg-primary-gray-300" }`} onClick={clickHandler}>
