...
export default function PrizeTable() {
  return (
    <div className="relative px-4 py-9 rounded-2xl my-4">
      ...
      <div className="relative text-3xl font-bold text-blue-500 -rotate-12 w-fit z-10">
        Rewards for Winners
      </div>
      <div className="relative z-10">
        ...
        <div className="flex justify-center gap-8 my-8">
          <div className="relative text-3xl w-1/3">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 aspect-[224/416] w-[30px]">
